...
export declare type ElementType<TProps = any> = {
    [TKey in keyof JSX.IntrinsicElements]: TProps extends JSX.IntrinsicElements[TKey] ? TKey : never;
}[keyof JSX.IntrinsicElements] | FunctionComponent<TProps>;
export declare type ComponentProps<TComponent extends keyof JSX.IntrinsicElements> = JSX.IntrinsicElements[TComponent];
